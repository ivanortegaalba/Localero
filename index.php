        ...
        <aside id="contenedorprincipal">
            ...
            <aside id="contenidocentral">
                ...
                <?php   
                                ...
                                $noticias=null;
                                $secciones = $conexion->getConsultaArray("SELECT nombreSeccion from secciones");
                                //Filtramos las noticias para solo dejar una de cada seccion:
                                for($i=0; $i < 5; $i++){
                                    $consulta = "SELECT * from noticias WHERE (seccion = '".$secciones[$i]["nombreSeccion"]."') ORDER BY fecha DESC  LIMIT 5";
                                    $noticias[$i]= $conexion->getConsultaArray($consulta);
                                }
                ?>
                <section id="noticias">
...
<!----------------COLUMNA 1----------------->
                    ...
                    <section id="col_noticias_1" class="col_noticia">
                        <?php imprimeNoticia($noticias[0]);?>
                        <?php imprimeNoticia($noticias[1]);?>
                        <?php imprimeNoticia($noticias[2]);?>
...
<!----------------COLUMNA 2----------------->
                    ...
                    <section id="col_noticias_2" class="col_noticia">
                        <?php imprimeNoticia($noticias[3]);?>
                        <?php imprimeNoticia($noticias[4]);?>
                    </section>
