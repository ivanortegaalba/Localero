...
<!----------COLUMNA 1----------------->
                        <form enctype="multipart/form-data" action= "registrarNoticia.php" method="POST">
                            ...
                            <textarea name="cuerpo" id="cuerpo" cols="500" rows="500"></textarea>
                            <p><label for="fecha">Fecha</label> 
                            <?php 
                                echo "<input type='date' name='fecha' id='fecha' value='".date("Y-m-d")."'/>"; 
                            ?>
                            ...
                            <input type="submit" name="boton" id="botonInsertar" 
                            value="Crear"  /> 
                        </form> 
                    </section>
            </aside>
